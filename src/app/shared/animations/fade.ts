...
// -----------------------------------------------------------------------------------------------------
// @ Fade In Inside Collapsed
// -----------------------------------------------------------------------------------------------------
const fadeInOutInsideCollapsed = trigger('fadeInOutInsideCollapsed', [
    state('true', style({ opacity: 1, transform: 'translateX(0)' })), // Estado cuando collapsed es true
    state('false', style({ opacity: 0, transform: 'translateX(-20px)' })), // Estado cuando collapsed es false

    transition('true <=> false', [ // Transición entre true y false
        animate(`${AnimationDurations.exiting} ${AnimationCurves.acceleration}`)
    ])
]);

export { fadeIn, fadeInTop, fadeInBottom, fadeInLeft, fadeInRight, fadeOut, fadeOutTop, fadeOutBottom, fadeOutLeft, fadeOutRight, fadeInOutInsideCollapsed };
