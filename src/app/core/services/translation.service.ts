  ...
  private translations: { [key: string]: TranslationData } = {
    en: {
      ...
      HOME: {
        ...
        DESCRIPTION: "Crafting dynamic scalable web solutions with a passion for technology.",
        ABOUT_SECTION: {
          TITLE: "About",
        ...
        EXPERIENCE_SECTION: {
          TITLE: "Experience",
          EVENT_LOOP_CLUB: {
            TITLE: "Frontend Engineer · Event Loop Club",
            DESCRIPTION: "I'm a founding member of this personal project developed with a group of developers. I serve as a Developer Frontend Engineer, contributing to the design and development of modern and efficient web applications. My focus includes building reusable components, integrating RESTful services, and performing unit and integration testing to ensure product quality. Additionally, I collaborate on the planning and execution of technical strategies to drive the project's growth.",
            DETAILED_PAGE: {
              ...
              LINKS: {
                ...
                LOGO: "assets/imgs/event_loop_club.svg",
                GITHUB: "",
    ...
    es: {
      ...
      HOME: {
        ...
        DESCRIPTION: "Creando soluciones web dinámicas y escalables con pasión por la tecnología.",
        ABOUT_SECTION: {
          TITLE: "Sobre mí",
        ...
        EXPERIENCE_SECTION: {
          ...
          EVENT_LOOP_CLUB: {
            TITLE: "Frontend Engineer · Event Loop Club",
            DESCRIPTION: "Soy miembro fundador de este proyecto personal desarrollado con un grupo de developers. Me desempeño como Developer Frontend Engineer, contribuyendo al diseño y desarrollo de aplicaciones web modernas y eficientes. Mi enfoque incluye construir componentes reutilizables, integrar servicios RESTful y realizar pruebas unitarias e integrales para garantizar la calidad del producto. Además, colaboro en la planificación y ejecución de estrategias técnicas para impulsar el crecimiento del proyecto.",
            DETAILED_PAGE: {
              ROLE_AND_RESPONSIBILITIES: {
                DESCRIPTION: "Desarrollador Frontend en un proyecto Angular con SSR. Mis responsabilidades incluyen mantener y optimizar código existente, crear componentes reutilizables y refactorizar para integrar nuevas funcionalidades. Además, trabajo estrechamente con el equipo para mejorar la arquitectura, asegurando una aplicación escalable y de alto rendimiento."
              },
              PROJECT_DESCRIPTION: {
